...
sl_led_pwm_t red_led_rgb = {
  .port = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RED_PORT,
  .pin = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RED_PIN,
  .level = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RESOLUTION - 1,
  .polarity = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RED_POLARITY,
  .channel = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RED_CHANNEL,
#if defined(SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RED_LOC)
  .location = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RED_LOC,
#endif
...
sl_led_pwm_t green_led_rgb = {
  .port = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_GREEN_PORT,
  .pin = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_GREEN_PIN,
  .level = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RESOLUTION - 1,
  .polarity = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_GREEN_POLARITY,
  .channel = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_GREEN_CHANNEL,
#if defined(SL_SIMPLE_RGBW_PWM_LED_LED_RGB_GREEN_LOC)
  .location = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_GREEN_LOC,
#endif
  .timer = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_PERIPHERAL,
  .frequency = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_FREQUENCY,
  .resolution = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RESOLUTION,
...
sl_led_pwm_t blue_led_rgb = {
  .port = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_BLUE_PORT,
  .pin = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_BLUE_PIN,
  .level = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RESOLUTION - 1,
  .polarity = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_BLUE_POLARITY,
  .channel = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_BLUE_CHANNEL,
#if defined(SL_SIMPLE_RGBW_PWM_LED_LED_RGB_BLUE_LOC)
  .location = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_BLUE_LOC,
#endif
  .timer = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_PERIPHERAL,
  .frequency = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_FREQUENCY,
  .resolution = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RESOLUTION,
...
sl_led_pwm_t white_led_rgb = {
  .port = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_WHITE_PORT,
  .pin = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_WHITE_PIN,
  .level = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RESOLUTION - 1,
  .polarity = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_WHITE_POLARITY,
  .channel = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_WHITE_CHANNEL,
#if defined(SL_SIMPLE_RGBW_PWM_LED_LED_RGB_WHITE_LOC)
  .location = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_WHITE_LOC,
#endif
  .timer = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_PERIPHERAL,
  .frequency = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_FREQUENCY,
  .resolution = SL_SIMPLE_RGBW_PWM_LED_LED_RGB_RESOLUTION,
